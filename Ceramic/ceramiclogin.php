...
<body>
    <center>
        <div class="login">
            <img src="../assets/images/ALOGO.png" alt="" style="width: 100%;">
            <br>
...
<script>
    function checkData() {
        ...
        }else if(document.getElementById('username').value == "Admin" && document.getElementById('admin_pass').value == password){
